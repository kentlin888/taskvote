...
export class ProjectInfo{
    projectId = 'ppp-ppppp';
    projectTitle = 'ppp-title';
}

export const ENUM_AssignTaskType={
    volunteer:"volunteer",
    random:"random",
    managerAssign:"managerAssign",
}
export const ENUM_MeetingCardStatus={
    onlyView:"onlyView",
    editLockIds:"editLockIds",
    initial:"initial",
}
export const ENUM_TaskViewMode={
    admin:"admin",
    evaluation:"evaluation",
    acception:"acception",
}
export const ENUM_taskCardSectionPanel = {
    taskInfoPanel: "taskInfoPanel",
    taskEvaluationPanel: "taskEvaluationPanel",
    taskAcceptionPanel: "taskAcceptionPanel",
}
export const ENUM_showAcceptionIcon = {
    showHand: "showHand",
    showCalendar: "showCalendar",
    showAll: "showAll",
    hideAll:"hideAll",
}
export const ENUM_evaluationStage={
    neverVote:"neverVote",
    voted:"voted",
...
export const ENUM_taskProcessLifeCycle={
...
export class MeetingInfo{
    ...
    projectId = 'ppp-jjj'
    meetingId = 'xxx-meetingId';
    meetingTitle = 'XXX-meetingTitle';
    meetingDesc = 'xxxx-meetingDesc';
    enumTaskProcessLifeCycle = ENUM_taskProcessLifeCycle.taskEditing

    docId=null;
    enumMeetingCardStatus = ENUM_MeetingCardStatus.initial;
    isSelected=false;
    /**@prop {?firebase.firestore.Timestamp} */
    fstsCreateDateTime_server = null;
    fill_fstsCreateDateTime_server = () => {
        this.fstsCreateDateTime_server = window.firebase.firestore.FieldValue.serverTimestamp();
    }
    clearData=() => {
        this.projectId = "";
        this.meetingId = "";
...
export class TaskEvaluation{
    userId="zzz-zzz";
    userEmail="kkk@aaa.com";

    projectId = 'zza-kkj';
    // meetingId = 'wwww-wwwww';
    taskId = 'xxx-xxx';
    // taskTitle = 'XXXXXX';
    // taskDesc = 'xxxxzzzzzyyyyyy';
    ...
    //==========Update time
    /**@prop {?firebase.firestore.Timestamp} */
    fstsUpdateDateTime_server = null;
    fill_fstsUpdateDateTime_server = () => {
        this.fstsUpdateDateTime_server = window.firebase.firestore.FieldValue.serverTimestamp();
    }
    /**@type {?Date} - server time conver to client js datetime*/ 
    get jsdtUpdateDateTime_server(){
        return (this.fstsUpdateDateTime_server == null) ? null : this.fstsUpdateDateTime_server.toDate();        
    }
    /**@property {string} */
    // get sCreateDateTime() {
    //     return getDisplayTime(this.jsdtCreateDateTime_server)
...
export class TaskInfo{
    ...
    isDoneBefore=false;
    //-----Assign
    assignUserId=null // not assigned
    assignUserEmail=null //not assigned
    assignType=ENUM_AssignTaskType.volunteer //ENUM_AssignTaskType
    assignStarNumber=0

    //-----taskCardStatus
    enumTaskCardSectionPanel = ENUM_taskCardSectionPanel.taskInfoPanel
    enumShowAcceptionIcon = ENUM_showAcceptionIcon.showHand
    enumEvaluationStage = ENUM_evaluationStage.neverVote
    enumTaskProcessLifeCycle = ENUM_taskProcessLifeCycle.taskEditing
    //other details
    ...
    isSavedEvaluation=false;
    isBtnEvaluationDisabled=false;
