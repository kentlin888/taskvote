        ...
        case ENUM_BUILD_SITE.ming:
            rtnConfig = {
                entry: {
                    ...
                    index: './console1/pages/index.js',
                    // ReactApp: './pages/ReactApp/ReactApp.js',
                },
                output: {
                    path: path.resolve(__dirname, 'dist', 'console1'),
                ...
                plugins: [
                    ...
                    new HtmlWebpackPlugin({
                        template: './console1/pages/index.htm', //path.join(__dirname, 'src', 'index.htm'),
                        filename: './pages/index.bundle.htm',
                        ...
                        favicon: './console1/assets/favicon.ico', //favicon路径
                        /*
                    ...
                    new CopyWebpackPlugin({
                        patterns: [
                            ...
                            {
                                from: 'console1/js/dataDefine/',
                                to: './js/dataDefine',
                                force: false
                            },
                            
                            {
                                from: 'console1/webcomponents/cusModalLogin3/cusModalLogin.htm',
                                to: './webcomponents/cusModalLogin3/cusModalLogin.htm',
                                force: false
                            },
                            
                            {
                                from: 'console1/webcomponents/cusModalUserProfile3/cusModalUserProfile.htm',
                                to: './webcomponents/cusModalUserProfile3/cusModalUserProfile.htm',
                                force: false
                            },
                            
                            {
                                from: 'console1/webcomponents/cusFullPageScroll/fullPageScroll.htm',
                ...
                devServer: {
                    ...
                    contentBase: path.resolve(__dirname, 'dist', 'console1'),
